  ...
  return (
    <GlassCard className="border border-white/20 h-full flex flex-col justify-between" hoverEffect={false}>
      ...
      <div className="flex items-center gap-2.5 pb-4 border-b border-black/5 mb-4">
        ...
        <div>
          <h3 className="text-[15px] font-bold text-foreground font-display">Ranking Insights</h3>
      ...
      <div className="space-y-4 flex-1">
        ...
        <div className="grid grid-cols-2 gap-3.5 pt-2">
          <div className="p-3.5 rounded-xl bg-black/[0.02] border border-black/[0.03] flex flex-col">
            <span className="text-[10px] text-foreground/50 font-bold uppercase tracking-wider">Current Percentile</span>
            <span className="text-lg font-extrabold text-brand-orange font-display mt-0.5">Top 15%</span>
          </div>

          <div className="p-3.5 rounded-xl bg-black/[0.02] border border-black/[0.03] flex flex-col">
            <span className="text-[10px] text-foreground/50 font-bold uppercase tracking-wider">Next Rank Goal</span>
            <span className="text-lg font-extrabold text-brand-blue font-display mt-0.5">Rank #4</span>
          </div>

          <div className="p-3.5 rounded-xl bg-black/[0.02] border border-black/[0.03] flex flex-col">
            <span className="text-[10px] text-foreground/50 font-bold uppercase tracking-wider">Points Needed</span>
            <span className="text-lg font-extrabold text-foreground font-display mt-0.5">+{pointsNeeded} pts</span>
          </div>

          <div className="p-3.5 rounded-xl bg-black/[0.02] border border-black/[0.03] flex flex-col">
            <span className="text-[10px] text-foreground/50 font-bold uppercase tracking-wider">Projected Rank</span>
            <span className="text-lg font-extrabold text-emerald-500 font-display mt-0.5">Rank #4</span>
          </div>
        </div>
      </div>
