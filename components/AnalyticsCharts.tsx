  ...
  return (
    <GlassCard className="border border-white/20 flex flex-col h-full" hoverEffect={false}>
      <div className="flex items-center gap-2 pb-4 mb-2 border-b border-black/5">
        ...
        <div>
          <h3 className="text-[15px] font-bold text-foreground font-display">Points Progress</h3>
  ...
  return (
    <GlassCard className="border border-white/20 flex flex-col h-full" hoverEffect={false}>
      <div className="flex items-center gap-2 pb-4 mb-2 border-b border-black/5">
        ...
        <div>
          <h3 className="text-[15px] font-bold text-foreground font-display">Participation Trend</h3>
  ...
  return (
    <GlassCard className="border border-white/20 flex flex-col h-full" hoverEffect={false}>
      <div className="flex items-center gap-2 pb-4 mb-2 border-b border-black/5">
        ...
        <div>
          <h3 className="text-[15px] font-bold text-foreground font-display">Achievement Distribution</h3>
